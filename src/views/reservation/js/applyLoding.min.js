...
//         var e = $.trim($("#input_5").val());
//         if (e) {
//             var t = 59;
//             $(this).hide(),
//             $("#showTime").show().text(t);
...
//             !1;
//         if (!o)
//             return $("#companyName").show(),
//             !1;
//         if ("请选择企业规模" == t)
//             return $("#selsectCompany").show(),
//             !1;
//         return /^([a-zA-Z]|[0-9])(\w|\-)+@[a-zA-Z0-9]+\.([a-zA-Z]{2,4})$/.test(i) ? /^1[3456789]\d{9}$/.test(s) ? void $.ajax({
...
//             },
//             success: function(e) {
//                 0 === e.head.error ? ($("#successSubmit").show(),
//                 setTimeout(function() {
//                     $("#successSubmit").hide(),
//                     history.go(-1)
//                 }, 3e3),
//                 localStorage.setItem("postInfo", "none")) : ($("#errorInfo").show(),
//                 $("#errorContent").text(e.head.message),
//                 setTimeout(function() {
//                     $("#errorInfo").hide()
//                 }, 3e3))
//             }
